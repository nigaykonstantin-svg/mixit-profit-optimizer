...
import { Settings, Save, ArrowLeft, Check, Loader2 } from 'lucide-react';
                    ...
                    <>
                        ...
                        <div className="flex gap-2 flex-wrap">
                            {configs.map((config) => (
                                <button
                                    key={config.category}
                                    onClick={() => handleTabChange(config.category)}
                                    className={`px-4 py-2 rounded-xl text-sm font-medium transition-all ${activeTab === config.category
